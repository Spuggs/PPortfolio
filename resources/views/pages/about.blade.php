      ...
      <div class="col-lg-6">
        ...
        <p class="lead">I'm Ramoi Perrin.
          ...
          share my knowledge with colleagues and students.
           ...
           <p class="lead"> Depending on the team and the requirements I’ve worked in many roles over the years. 
          ...
          <form action="/contact" method="get" target="_blank">
            <button type="submit" class="btn btn-primary btn-lg px-4 me-md-2">Start a Conversation.</button>
         </form>
      </div>
    </div>
  </div>
